...
import { BigPrice, BigTitle, NormalText, SmallPrice, Text } from "../../atoms/typography";
interface Result
{
    author: {
        name: "Jorge";
...
const PriceWrapper = styled.div`
 grid-column: 1 / span 12;
  ...
  .space__big{
      &--top{  margin-top: ${ (margin) => margin.theme.margin.large };}
      &--bottom{  margin-bottom: ${ (margin) => margin.theme.margin.large };}
  }
  .space__small{ margin-bottom: ${ (margin) => margin.theme.margin.small };}
